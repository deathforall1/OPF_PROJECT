...
\begin{warnbox}\boxtitler{Provenance of this subsection and the next}
As with Ambuja, the board composition and the shareholding split could not be verified
against a primary document from the working environment used to prepare this report:
the exchange and company domains were unreachable, so neither the Corporate Governance
Report nor the Regulation 31 shareholding filing could be opened directly. Both are
recorded as open items in Appendix I and should be checked against the FY2025-26
annual report before submission.
\end{warnbox}
...
segment. Birla White is small in revenue but higher-margin. The split shown is
indicative of the disclosed segment mix. Source: FY2025-26 integrated report; authors'
analysis.}
...
\begin{extab}{Board and key management}{Composition is an OPEN ITEM pending
verification against the FY2025-26 Corporate Governance Report — see Appendix I.}
\begin{tabular}{@{}p{0.40\linewidth}p{0.52\linewidth}@{}}
\hrow \wh{Name} & \wh{Capacity}\\
Kumar Mangalam Birla & Chairman, Non-Executive\\
\arow Rajashree Birla & Non-Executive Director\\
K.C. Jhanwar & Managing Director to 31-Mar-26\\
\arow Jayant Dua & Managing Director from 1-Apr-26\\
Atul Daga & Chief Financial Officer\\
\arow Vivek Agrawal & Whole-Time Director \& CMO\\
\end{tabular}
\end{extab}
