...
\runheadlogo{logo_utcl}{Part II \textbar\ UltraTech Cement}
...
UltraTech Cement Ltd is the cement business of the Aditya Birla group and India's
largest cement producer by capacity — and the largest outside China. It took its
present form in 2004 when Grasim Industries acquired control of the cement business
demerged from L\&T, and it has grown through a sequence of large transactions since:
the Jaypee assets, Century Textiles' cement business, and most recently The India
Cements and Kesoram's cement assets. Standalone grey cement sales were 140.75 million
tonnes in FY2025-26 on revenue of Rs 82,170 crore, with consolidated capacity of
roughly 192 MTPA and management guidance pointing to 218 MTPA and then 240--245 MTPA.

The company is run from Mumbai and is listed on both the NSE and the BSE. Its scale is
genuine and is not in dispute in this report: the largest capacity base, the widest
geographic spread in a freight-constrained industry, and the balance sheet to absorb
distressed assets when they come to market.

\begin{keybox}\boxtitle{Scale is the strength and the problem}
UltraTech's growth record is one of the strongest in Indian industry — volume
compounding at 12.5\% a year for a decade. But volume was bought with capital rather
than earned through price: realisation compounded at 2.0\% over the same decade.
The ten-year history section sets out what that did to the return on capital.
\end{keybox}

\subsection{Products and brands}

Grey cement under the UltraTech brand is the reported primary segment and the
overwhelming majority of revenue: Ordinary Portland, Portland Pozzolana and Portland
Slag Cement, with premium variants such as UltraTech Super and UltraTech Weather Plus
carrying higher realisation. Alongside it sits \textbf{Birla White}, the white cement,
wall putty and wall-care business, which is small in revenue terms but earns a
materially higher margin than grey cement and gives the group a genuine branded
consumer franchise. Ready-mix concrete and the UltraTech Building Solutions retail
network complete the portfolio, the latter functioning as a distribution asset as much
as a product line.

The relevant analytical point is that the premium and white-cement businesses are not
large enough to change the group's economics. UltraTech is a grey cement company, and
its value turns on tonnes and on EBITDA per tonne, which is why the forecast is built
that way.

\subsection{Board of directors}

The board is chaired by \textbf{Kumar Mangalam Birla}, with \textbf{Rajashree Birla}
also serving as a non-executive director on behalf of the promoter group.
\textbf{K.C. Jhanwar} served as Managing Director from January 2020, with
\textbf{Jayant Dua} elevated to Managing Director with effect from 1 April 2026 — a
transition that falls immediately after this report's valuation date and is worth
noting, because the integration programme the bull case depends on will be executed
under new leadership. \textbf{Atul Daga} is Chief Financial Officer, and
\textbf{Vivek Agrawal} is a Whole-Time Director and Chief Marketing Officer.

\begin{okbox}\boxtitleg{Sourcing note}
Board and management composition is taken from the company's own Board of Directors
and Management Team disclosures; the shareholding pattern is from the company's
shareholding-pattern filing. Nothing in this section comes from a financial data
aggregator. The one open item is the reported managing-director transition effective
1 April 2026, recorded in Appendix I.
\end{okbox}

\subsection{Shareholders and shareholding pattern}

UltraTech is controlled by the Aditya Birla group, principally through
\textbf{Grasim Industries Ltd}, with the balance of the promoter holding spread across
other group entities. The remainder is a large and liquid institutional and retail
float; UltraTech is a Nifty 50 constituent and one of the most widely held industrial
names in the Indian market.

At the June 2026 filing the promoter group held \textbf{59.33\%}, public institutions
32.55\%, public non-institutions 7.95\% and non-promoter non-public holders 0.17\%.
Promoter shares are unpledged. Within the institutional block, June 2026 data show
foreign ownership falling while domestic mutual-fund and insurance ownership increased
— a rotation worth noting, because it means the marginal buyer of this stock has
recently been domestic rather than global.

The register is analytically relevant here for the same reason as at Ambuja, and for
one additional reason. The free float is deep and the stock is heavily covered, so the
53\% gap this report identifies is not a pricing anomaly in a neglected security — it
is a disagreement with a well-informed market about what a mature cement franchise
earning roughly its cost of capital is worth. That is a stronger claim, and the
sensitivity and catalysts section sets out the specific, testable disclosures that
would settle it.

\subsection{Operating footprint}

The manufacturing base exceeds 200 MTPA of consolidated capacity across integrated
plants, grinding units and bulk terminals, supported by more than 130 ready-mix
concrete plants. National scale, limestone reserves and multimodal logistics give
regional availability and procurement leverage that smaller producers cannot match in
a freight-constrained industry.

Green power reached 43\% of the energy mix against a stated ambition of 65\%, and
management guides roughly Rs 300 per tonne of cost saving over two to three years from
green power, waste heat recovery, alternative fuels and lower-clinker products. Our
forecast captures about two-thirds of that guided saving — deliberately below the
company's own target, and well below the sell side.

\begin{keybox}\boxtitle{Scale is real; the question is what was paid for it}
Nothing in this section is in dispute. UltraTech has the largest capacity base, the
widest geographic spread and the strongest distribution in Indian cement. The
valuation question is not whether the franchise is good. It is whether a good
franchise earning 10.8\% on capital against an 11.43\% cost of capital is worth 3.3
times the capital employed.
\end{keybox}

\switchcolumn
\ex{utcl_ownership.png}{\textbf{Exhibit U15.} The India Cements remained separately
listed at the valuation date. The subsidiary block it sits in is under 10\% of group
EBITDA, which is the quantitative justification for the standalone-core basis. Source:
FY2025-26 integrated report, non-current investments note.}

\ex{utcl_ownership_donut.png}{\textbf{Exhibit U17.} Promoter control is stable and
unpledged, and the institutional float is large — UltraTech is a Nifty 50 constituent.
June 2026 data show foreign ownership falling while domestic mutual-fund and insurance
ownership rose. Source: UltraTech shareholding-pattern filing.}

\begin{extab}{The company at a glance}{Source: FY2025-26 Integrated and Sustainability
Report; NSE close 30 March 2026.}
\begin{tabular}{@{}p{0.46\linewidth}r@{}}
\hrow \wh{Item} & \wh{Value}\\
Present form since & 2004\\
\arow Promoter group & Aditya Birla\\
Principal promoter entity & Grasim Industries\\
\arow Registered office & Mumbai\\
Listings & NSE, BSE\\
\arow Consolidated capacity (MTPA) & c.192\\
Guided capacity, FY29 (MTPA) & 240--245\\
\arow Standalone volume FY26 (Mn.T) & 140.75\\
Standalone utilisation FY26 & 81.6\% \\
\arow Standalone revenue (Rs cr) & 82,170\\
Standalone EBITDA (Rs cr) & 15,439\\
\arow EBITDA per tonne (Rs) & 1,097\\
Shares outstanding (crore) & 29.468\\
\arow Market capitalisation (Rs cr) & 316,633\\
Listed subsidiary & India Cements (74.99\%)\\
\arow Standalone \% of group EBITDA & 90.7\% \\
\end{tabular}
\end{extab}

\begin{extab}{Board metrics}{Source: UltraTech Board of Directors disclosures.}
\begin{tabular}{@{}p{0.62\linewidth}r@{}}
\hrow \wh{Metric} & \wh{Value}\\
Directors on the board & 10\\
\arow of which independent & 5\\
\trow \textbf{Independent directors} & \textbf{50\%}\\
Executive directors & 2\\
\arow Principal committees & 6\\
Managing Director since & January 2020\\
\arow Reported MD transition & 1 April 2026\\
\end{tabular}
\end{extab}

\begin{notebox}\boxtitlea{A leadership transition at the valuation date}
The managing directorship changed hands on 1 April 2026, the day after this report's
valuation date. The bull case rests on an integration programme — lifting India
Cements from Rs 386 per tonne toward the Rs 966 the core assets earn — that will now
be executed under new leadership. That is not a reason to change the numbers, but it
is a reason to watch the first two quarterly EBITDA-per-tonne prints closely.
\end{notebox}

\end{paracol}
\clearpage

\fullhead{Board of directors}{UltraTech Cement Ltd, as constituted at 31 March 2026.
Source: UltraTech Board of Directors; company pages, FY2025-26.}

\noindent
\person{0.092\textwidth}{utcl_km_birla.png}{Kumar Mangalam Birla}{Chairman}\hfill
\person{0.092\textwidth}{utcl_rajashree_birla.png}{Rajashree Birla}{Non-executive Director}\hfill
\person{0.092\textwidth}{utcl_kk_maheshwari.png}{K. K. Maheshwari}{Vice Chairman, Non-executive}\hfill
\person{0.092\textwidth}{utcl_kc_jhanwar.png}{K. C. Jhanwar}{Managing Director}\hfill
\person{0.092\textwidth}{utcl_vivek_agrawal.png}{Vivek Agrawal}{Whole-time Director \& CMO}\hfill
\person{0.092\textwidth}{utcl_ak_agrawal.png}{Anjani Kumar Agrawal}{Independent Director}\hfill
\person{0.092\textwidth}{utcl_vikas_balia.png}{Vikas Balia}{Independent Director}\hfill
\person{0.092\textwidth}{utcl_vikram_bhalla.png}{Vikram Bhalla}{Independent Director}\hfill
\person{0.092\textwidth}{utcl_v_chandrasekaran.png}{V. Chandrasekaran}{Independent Director}\hfill
\person{0.092\textwidth}{utcl_anita_ramachandran.png}{Anita Ramachandran}{Independent Director}

\vspace{6mm}
\begin{paracol}{2}
\subsection*{Composition and coverage}

The board combines promoter stewardship, operating leadership and independent
expertise across finance, investment, governance, law, human capital and industrial
operations. Five of the ten directors are independent. Principal committees cover
audit, stakeholders, nomination and remuneration, corporate social responsibility,
finance, and risk management and sustainability.

\begin{notebox}\boxtitlea{A leadership transition immediately after the valuation date}
K.\,C. Jhanwar served as Managing Director from January 2020 and is shown here as the
board stood at 31 March 2026. A transition to \textbf{Jayant Dua} as Managing
Director with effect from 1 April 2026 was reported but could not be confirmed
against a primary filing from this working environment; it is carried as an open item
in Appendix I. Either way the point stands: the integration programme the bull case
depends on will be executed under changed leadership, so the first two quarterly
EBITDA-per-tonne prints matter more than usual.
\end{notebox}

\switchcolumn
\subsection*{Where independent challenge should bite}

The board's most consequential decisions concern capital allocation across organic
expansion, acquisitions and the newer building-materials adjacencies. Independent
oversight matters most where integration assumptions, impairment testing,
related-party governance and sustainability commitments intersect with long-duration
investment.

\begin{keybox}\boxtitle{The governance question at UltraTech is different from Ambuja's}
At Ambuja the question is whether acquisition goodwill can ever earn its cost. At
UltraTech the company \emph{does} earn above its cost of capital, so the question is
narrower: whether the board holds management to a return on the enlarged asset base
rather than to absolute EBITDA growth. Reported ROIC fell from 14.5\% in FY2021-22 to
10.8\% in FY2025-26 while EBITDA rose — precisely the pattern a scale-focused
scorecard would miss.
\end{keybox}
\end{paracol}

\vspace{4mm}
\fullhead{Senior management}{The operating team. Source: UltraTech Management Team;
company pages, FY2025-26.}

\noindent
\person{0.115\textwidth}{utcl_kc_jhanwar.png}{K. C. Jhanwar}{Managing Director}\hfill
\person{0.115\textwidth}{utcl_raj_narayanan.png}{E. R. Raj Narayanan}{Business Head \& Chief Manufacturing Officer}\hfill
\person{0.115\textwidth}{utcl_vivek_agrawal.png}{Vivek Agrawal}{Whole-time Director \& Chief Marketing Officer}\hfill
\person{0.115\textwidth}{utcl_atul_daga.png}{Atul Daga}{Business Head \& Chief Financial Officer}\hfill
\person{0.115\textwidth}{utcl_cs_chavan.png}{Chandrashekhar Chavan}{Chief Human Resources Officer}\hfill
\person{0.115\textwidth}{utcl_anand_l.png}{Anand Laxshmivarahan R.}{Chief Digital \& Information Officer}\hfill
\person{0.115\textwidth}{utcl_ashok_kumar.png}{P. Ashok Kumar}{Executive President \& Chief Legal Officer}\hfill
\person{0.115\textwidth}{utcl_ashish_dwivedi.png}{Ashish Dwivedi}{CEO -- Birla White}

\vspace{5mm}
\begin{paracol}{2}
\textbf{Execution priorities.} Integrate India Cements and Kesoram, fill commissioned
capacity, protect unit economics, convert the enlarged footprint into cash, and hold
discipline across procurement, logistics, capex and working capital. The most useful
management scorecard is EBITDA per tonne, utilisation, core cash conversion and ROIC.

\switchcolumn
\textbf{Operating scorecard.} Quarterly volume and EBITDA growth should be read
alongside utilisation, EBITDA per tonne, capex per incremental tonne, inventory and
receivable days, and ROIC. Those measures distinguish scale that creates value from
scale that merely adds revenue and depreciable assets — which is the whole question
at this price.
\end{paracol}
\clearpage
...
The same three disclosures examined for Ambuja tell a materially better story at
UltraTech, and the contrast is the most useful evidence in this report for why one
company is the difficult name and the other the easy one.

\subsection{The gain reached the operating line}

Manufacturing gross margin rose from 57.7\% to 58.4\% and delivered gross margin
improved two points to 36.8\%. Unlike at Ambuja, the improvement was \emph{not}
absorbed by overhead: consolidated EBITDA margin expanded from 16.5\% to 19.2\% and
EBIT margin reached 14.0\%. Direct cost improvement and better absorption both
reached the operating line.

\subsection{Depreciation did not eat the gain}

D\&A increased 15.7\% to Rs 4,644 crore, broadly in line with revenue growth.
Intensity was stable at 5.25\% of revenue and \emph{fell} from 32.0\% to 27.3\% of
EBITDA. The enlarged asset base did not dilute EBIT conversion in FY2025-26. Compare
that with Ambuja, where D\&A rose 55.4\% against 15.1\% revenue growth and consumed
54.4\% of EBITDA.

\subsection{Working capital improved on the right lines}

Inventory days fell 5.6 and receivable days fell 3.4, more than offsetting a 1.4-day
reduction in payable days. The closing-balance cash conversion cycle improved from
29.7 to 22.1 days and core trade-cycle working capital released about Rs 639 crore.
This is a cleaner improvement than Ambuja's, which came mostly from stretching
payables.

\begin{keybox}\boxtitle{Why this does not change the recommendation}
Everything above is genuinely good, and none of it closes the gap. UltraTech converts
scale into operating margin competently; the problem is the price paid for the scale.
Operating cash flow rose from Rs 10,673 crore to Rs 15,316 crore while purchases of
property, plant and equipment rose only from Rs 9,129 crore to Rs 9,678 crore — so the
business now covers its own expansion. It still does not earn enough on Rs 86,090
crore of invested capital to justify 3.3 times that figure.
\end{keybox}

\switchcolumn
\ex{utcl_marginstack.png}{\textbf{Exhibit U18.} Consolidated basis, so the EBITDA
margin differs from the 18.8\% standalone figure used in the valuation. Definitions
as in Exhibit A21. Source: FY2025-26 consolidated financial results.}

\ex{utcl_ccc.png}{\textbf{Exhibit U19.} Closing-balance proxies on the same
definitions used for Ambuja. Source: FY2025-26 consolidated results and balance
sheet.}

\begin{extab}{Balance sheet and cash flow bridge}{Consolidated. Source: FY2025-26
consolidated financial results and balance sheet.}
\begin{tabular}{@{}p{0.52\linewidth}rr@{}}
\hrow \wh{Rs crore} & \wh{FY25} & \wh{FY26}\\
Revenue from operations & 75,955 & 88,512\\
\arow Cash operating cost & 63,398 & 71,491\\
Inventory & 9,563 & 9,694\\
\arow Trade receivables & 5,890 & 6,029\\
Trade payables & 9,327 & 10,237\\
\arow Core trade-cycle working capital & 6,126 & 5,486\\
\trow \textbf{Cash flow from operations} & \textbf{10,673} & \textbf{15,316}\\
Purchase of PPE & 9,129 & 9,678\\
\arow D\&A & 4,014 & 4,644\\
D\&A \% of revenue & 5.28\% & 5.25\% \\
\arow D\&A \% of EBITDA & 32.0\% & 27.3\% \\
\end{tabular}
\end{extab}

\begin{okbox}\boxtitleg{What to watch}
Whether delivered gross-margin gains survive normalisation in fuel cost and regional
prices; whether inventory and receivable days stay lower as India Cements and Kesoram
are fully consolidated; whether operating cash flow keeps covering expansion without a
renewed leverage cycle; and whether the enlarged base lifts ROIC above the cost of
capital rather than only raising absolute EBITDA.
\end{okbox}

\switchcolumn*
\section{Products and brands}

UltraTech's portfolio runs from foundation materials to finishes, which management
describes as a 360-degree strategy. It matters commercially and it matters much less
to this valuation than tonnes and cost per tonne.

\subsection{Cement and concrete}

Ordinary Portland, Portland Pozzolana and Portland Slag cement serve housing,
commercial and infrastructure demand under the UltraTech brand, with premium variants
including UltraTech Super and Weather Plus. UltraTech is also India's largest
ready-mix concrete producer, with a network of more than 130 plants and both
conventional and value-added concrete offerings.

\subsection{Birla White}

White cement, wall putty, waterproofing, tile adhesives and grouts, gypsum plaster,
primers and textured finishes extend the portfolio from structural construction into
surface preparation and finishing. This is the group's genuine branded consumer
franchise and it earns a materially higher margin than grey cement — but it is small
relative to the whole.

\subsection{Building solutions}

UltraTech Building Products covers waterproofing, crack fillers, tile and marble
systems, specialist plaster, repair products, industrial grouts and AAC blocks.
UltraTech Building Solutions adds technical advice and retail access, functioning as
a distribution asset as much as a product line.

\begin{okbox}\boxtitleg{The analytical weighting}
The adjacencies are strategically sensible and commercially real. They are not large
enough to change the economics of a business selling 140.75 million tonnes of grey
cement. That is why the forecast is built on capacity times utilisation times EBITDA
per tonne, and why the sensitivity analysis is run on those drivers rather than on
product mix.
\end{okbox}

\switchcolumn
\ex{utcl_products.png}{\textbf{Exhibit U16.} Grey cement is the reported primary
segment. The split shown is indicative of the disclosed segment mix. Source:
FY2025-26 integrated report; UltraTech product portfolio; Birla White.}

\begin{extab}{Operating footprint}{Source: FY2025-26 results and company disclosures.}
\begin{tabular}{@{}p{0.60\linewidth}r@{}}
\hrow \wh{Item} & \wh{Value}\\
Manufacturing capacity, consolidated & 200+ MTPA\\
\arow Ready-mix concrete plants & 130+\\
Standalone grey cement volume FY26 & 140.75 Mn.T\\
\arow Standalone capacity (derived) & 172.5 Mn.T\\
Green power share & 43\% \\
\arow Guided green power share & 65\% \\
Guided cost saving & Rs 300/tonne\\
\end{tabular}
\end{extab}

\begin{keybox}\boxtitle{Strategic positioning, in the company's own terms}
National scale, limestone reserves and multimodal logistics support regional
availability and procurement leverage. The India Cements and Kesoram acquisitions
accelerate southern and eastern market access but raise integration and
return-on-capital requirements. Green power, waste heat recovery, alternative fuels
and lower-clinker products are both cost and decarbonisation levers.
\end{keybox}
...
with roughly 6--7\% volume demand growth. At about 141 million tonnes of standalone
sales against industry production of 491.4 million tonnes, it accounts for roughly
\textbf{29\% of Indian cement output} — nearly twice Ambuja's share.

Its competitive position is genuinely strong: the largest capacity base, the widest
geographic spread, limestone reserves, multimodal logistics and the balance sheet to
absorb distressed assets when they come to market. In a business where cement cannot
travel far economically, regional density is the moat, and UltraTech has more of it
than anyone. None of that is in dispute here.

\subsection{What is in dispute is the price}

The industry has been adding capacity at least as fast as demand grows. Installed
capacity is projected to reach roughly 850 MTPA by 2030, a 5.1\% compound rate, against
volume growth of 7--8\%. Sector utilisation therefore improves only slowly and sits
near 80\%. In that environment scale buys resilience rather than pricing power, and
acquisitions bought at full prices dilute returns before they improve them.

\subsection{The cost side is where the leverage is}

Because price is competitive, the operating lever that matters is cost per tonne.
Management guides roughly Rs 300 per tonne of saving over two to three years from green
power rising from 43\% to 65\% of the energy mix, waste heat recovery, alternative
fuels and lower-clinker products. Our forecast captures about two-thirds of that. The
same programme is the company's decarbonisation plan, which is why this report does not
apply a separate ESG adjustment — doing so would count the same effect twice.

\begin{keybox}\boxtitle{The reverse cross-check on the sector multiple}
A 19.05x exit EV/EBITDA — the peer median — implies terminal growth of 9.8\% against a
WACC of 11.43\% and nominal GDP of 10.76\%. That is growth at roughly 91\% of the whole
economy in perpetuity, from a company whose realisation has compounded at 2.0\% over
ten years. The first figure in the reverse table that is arguable is an 8x exit
multiple, which implies 6.8\% growth.
\end{keybox}

\subsection{Where the acquisitions fit}

The India Cements and Kesoram transactions accelerate access to southern and eastern
markets, which is the one part of the country where UltraTech's regional density was
weakest. Strategically the logic is sound. Financially the test is narrow and
measurable: those assets earn Rs 386 and Rs 755 of EBITDA per tonne against Rs 966 for
the core. Closing that gap is the entire bull case, and it is the reason blended EBITDA
per tonne is the single disclosure this report asks readers to watch.

\switchcolumn
\ex{ind_india.png}{\textbf{Exhibit U20.} Industry production and the two companies'
directional share of it. Sources: IBEF, Indian Cement Industry, May 2026; ICRA volume
outlook; company reports.}

\ex{utcl_pertonne.png}{\textbf{Exhibit U10.} The acquisition drag, in management's own
numbers. Closing the gap between Rs 386 and Rs 966 is the entire bull case. Source:
management commentary relayed through broker research — flagged for re-sourcing from
the earnings call transcript.}

\begin{extab}{Competitive position}{Sources: IBEF, May 2026; company reports.}
\begin{tabular}{@{}p{0.58\linewidth}r@{}}
\hrow \wh{Measure} & \wh{Value}\\
Industry production FY26 & 491.4 Mn.T\\
\arow UltraTech standalone volume & 140.8 Mn.T\\
\trow \textbf{Share of output} & \textbf{c.29\%}\\
Ambuja share of output & c.15\% \\
\arow Consolidated capacity & 200+ MTPA\\
Guided capacity FY29 & 240--245 MTPA\\
\arow Ready-mix plants & 130+\\
Sector utilisation & c.80\% \\
\arow 2030 industry capacity projection & 850 MTPA\\
2025--30 capacity CAGR & 5.1\% \\
\end{tabular}
\end{extab}

\begin{warnbox}\boxtitler{Scale is not the same as returns}
UltraTech is roughly twice Ambuja's size in output and earns roughly three times its
return on capital, which is why it is the better business. It also trades at 3.3 times
invested capital against Ambuja's 1.66 times. On our terminal returns, UltraTech's
price is about 1.6 times what its own return on capital justifies. Being the best house
in the street does not make the street cheap.
\end{warnbox}
