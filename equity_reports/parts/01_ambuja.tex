...
The board is chaired by \textbf{Gautam S Adani} in a non-executive capacity, with
\textbf{Karan Adani} as a non-executive, non-independent director representing the
promoter group. \textbf{Vinod Bahety} is Whole-Time Director and Chief Executive
Officer, and is the executive accountable for the integration programme on which this
valuation turns. The independent contingent includes \textbf{Rajnish Kumar}, former
Chairman of the State Bank of India, alongside \textbf{M S Sahu} and, on a recent
appointment, \textbf{Praveen Garg}.

\begin{warnbox}\boxtitler{Provenance of this subsection and the next}
The board composition and the institutional shareholding split below could not be
verified against a primary document from the working environment used to prepare this
report: the exchange and company domains were unreachable, so the annual report's
Corporate Governance Report and the Regulation 31 shareholding filing could not be
opened directly. The promoter percentage is company-disclosed and is reliable. The
names, designations and category splits should be checked against the FY2025-26
Corporate Governance Report before submission. They are recorded here as open items
in Appendix I rather than presented as sourced facts.
\end{warnbox}
...
\ex{amb_shareholding.png}{\textbf{Exhibit A19.} Promoter holding is company-disclosed.
The category split of the public float is an open item — see Appendix I. Source:
company disclosures.}
...
\begin{extab}{Board of directors}{Composition is an OPEN ITEM pending verification
against the FY2025-26 Corporate Governance Report — see Appendix I.}
\begin{tabular}{@{}p{0.42\linewidth}p{0.50\linewidth}@{}}
\hrow \wh{Name} & \wh{Capacity}\\
Gautam S Adani & Chairman, Non-Executive\\
\arow Karan Adani & Non-Executive, Non-Independent\\
Vinod Bahety & Whole-Time Director \& CEO\\
\arow Rajnish Kumar & Independent, Non-Executive\\
M S Sahu & Independent, Non-Executive\\
\arow Praveen Garg & Independent, Non-Executive\\
\end{tabular}
\end{extab}
...
economically, so competition is decided within a few hundred kilometres of a plant
and national market share means less than regional density. Demand is driven by
housing, infrastructure and government capital expenditure, and has grown at roughly
6--7\% a year in volume terms.

Three features of the current cycle matter for this valuation. First, the industry
has been adding capacity faster than demand, which holds utilisation near 80\% and
caps pricing power. Second, realisation has been flat to falling in real terms:
...
prices that put goodwill on balance sheets — which is exactly the problem this
report measures.
