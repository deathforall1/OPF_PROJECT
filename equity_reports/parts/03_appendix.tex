...
23 & AMB & Promoter holding 67.64\% at 31-Mar-26 (67.68\% voting rights); 67.29\% from 10-Apr-26 & Ambuja Cements Ltd & Company disclosure of the Sanghi amalgamation share issue of 1,29,93,708 equity shares. Primary-sourced and reliable. & 30-Aug-26\\
\arow 24 & Both & \textbf{OPEN:} board composition and designations & Company annual reports & The Corporate Governance Report in each FY2025-26 annual report could not be opened directly from the working environment: the company and exchange domains were unreachable through the network egress policy in force. Names and designations in Sections 2 and 14 are recorded pending verification against that report. & 30-Aug-26\\
25 & Both & \textbf{OPEN:} shareholding pattern by investor category & Exchange filings & The Regulation 31 quarterly shareholding filing could not be opened for the same reason. Only the promoter/free-float split is presented, and only for Ambuja, where it is company-disclosed. The institutional split (FPI, mutual fund, insurance, retail) is deliberately NOT printed rather than taken from an aggregator. & 30-Aug-26\\
\arow 26 & UTCL & \textbf{OPEN:} promoter holding percentage & Exchange filings & UltraTech's promoter holding at 31-Mar-2026 could not be sourced primarily and is therefore described qualitatively (Aditya Birla group through Grasim Industries) rather than quantified. & 30-Aug-26\\
\end{tabular}\par}

\vspace{2mm}
\begin{warnbox}\boxtitler{Why three rows above say OPEN rather than carrying a number}
Board rosters and category-level shareholding data are freely available on financial
aggregator sites. This report's sourcing policy excludes them, and the company and
exchange domains were unreachable from the environment in which it was prepared. The
choice was therefore between printing an aggregator figure in a report whose central
claim is source discipline, or printing the structure and marking the gap. We marked
the gap. Each item is a single lookup in the FY2025-26 annual report and the
Regulation 31 filing, and Sections 2 and 14 are laid out so the figures drop straight
in.
\end{warnbox}
