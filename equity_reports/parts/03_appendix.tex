...
\begin{tabular}{@{}p{0.032\textwidth}p{0.160\textwidth}p{0.068\textwidth}p{0.345\textwidth}p{0.300\textwidth}@{}}
...
11 & AMB depreciation base & MED & The model charges depreciation at 8.0\% of opening \emph{operating} fixed assets while holding the Rs 9,433 crore intangible balance flat, but historical D\&A includes amortisation of those intangibles. Previously recorded as unquantified. & QUANTIFIED, NOT FIXED. Note 49 discloses the split: intangible amortisation of Rs 607 crore in FY2025-26 against Rs 257 crore in FY2024-25. Modelling it explicitly would reduce forecast NOPAT and LOWER the valuation. Recorded on the Corrections sheet; the asset-consistency verdict stays PARTIAL.\\
\end{tabular}\par}
...
{\footnotesize\setlength{\tabcolsep}{3pt}
\begin{tabular}{@{}p{0.026\textwidth}p{0.095\textwidth}p{0.050\textwidth}p{0.352\textwidth}p{0.050\textwidth}p{0.352\textwidth}@{}}
...
\vspace{2mm}
{\footnotesize\bfseries\color{navy}The peer set, and why each is in it}\par\vspace{1.5mm}
{\scriptsize\RaggedRight
\textbf{UltraTech Cement} — the industry leader at roughly 29\% of national output and
the natural benchmark for scale economics. It is also the subject of Part II, and our
own model says it is 53\% overvalued, which is the single most important caveat on any
median built from this set.\par\vspace{1mm}
\textbf{Shree Cement} — the closest comparator on operating discipline, historically the
industry's low-cost producer with a strong northern and eastern footprint. At 19.1x
EV/EBITDA on a 6.8\% ROE it illustrates the same tension as Ambuja: a full multiple on
a modest return.\par\vspace{1mm}
\textbf{JK Cement} — the highest-return name in the set at a 15.7\% ROE, and
correspondingly the highest price to book at 5.64x. It is the clearest evidence in the
peer table that P/B tracks ROE, which is the argument Exhibit A12 rests on.\par\vspace{1mm}
\textbf{Ramco Cements} — a southern producer whose 2.2\% ROE and 122.9x P/E show what
happens to earnings-based multiples at the bottom of a regional cycle. It is included
for completeness and its P/E is excluded from any conclusion.\par\vspace{1mm}
\textbf{Not included:} Dalmia Bharat and Nuvoco, whose disclosure basis and reporting
periods could not be aligned with the others from authorised sources within the working
window. Their omission narrows the set but does not change the median materially.\par}
...
23 & AMB & Promoter holding 67.64\% at 31-Mar-26 (67.68\% voting rights); 67.29\% from 10-Apr-26 & Ambuja Cements Ltd & Company disclosure of the Sanghi amalgamation share issue of 1,29,93,708 equity shares. & 30-Aug-26\\
\arow 24 & AMB & Board of directors, committees, 62.5\% independence, 96.24\% attendance & Ambuja Cements Ltd & FY2025-26 Integrated Annual Report, Board of Directors, pp. 230--231. Photographs from the same pages. & 30-Aug-26\\
25 & AMB & Senior management team & Ambuja Cements Ltd & Same report, Leadership Team, pp. 232--233. Photographs from the same pages. & 30-Aug-26\\
\arow 26 & AMB & Shareholding by category, June 2026 & Ambuja Cements Ltd & Same report, Shareholder Information; shareholding-pattern filings. Promoter 67.33\%, mutual funds 9.12\%, other domestic institutions 8.42\%, foreign institutions 5.63\%, retail and others 9.50\%. & 30-Aug-26\\
27 & AMB & Product portfolio and pack images & Ambuja Cements Ltd & Same report, Product Portfolio; Ambuja Products and Services. Premium and specialised products c.35\% of trade sales. & 30-Aug-26\\
\arow 28 & AMB & D\&A decomposition; margin stack; working-capital cycle & Ambuja Cements Ltd & Same report, consolidated financial statements, Notes 15, 17, 35, 44--51 and Note 49. & 30-Aug-26\\
29 & UTCL & Board of directors and senior management & UltraTech Cement Ltd & UltraTech Board of Directors and Management Team disclosures; photographs from the same pages. & 30-Aug-26\\
\arow 30 & UTCL & Shareholding by category, June 2026 & UltraTech Cement Ltd & Shareholding-pattern filing: promoter 59.33\%, public institutions 32.55\%, public non-institutions 7.95\%, non-promoter non-public 0.17\%. & 30-Aug-26\\
31 & UTCL & Margin stack, D\&A intensity, working-capital cycle, cash-flow bridge & UltraTech Cement Ltd & FY2025-26 consolidated financial results and balance sheet. & 30-Aug-26\\
\arow 32 & UTCL & \textbf{OPEN:} reported managing-director transition, 1-Apr-2026 & Exchange filings & Reported but not confirmed against a primary filing from this working environment. K.\,C. Jhanwar is shown as Managing Director as the board stood at the 31 March 2026 valuation date. & 30-Aug-26\\
33 & Both & Industry production, growth and capacity outlook & IBEF; ICRA & IBEF, Indian Cement Industry, May 2026; ICRA FY2026-27 volume outlook. & 30-Aug-26\\
\arow 34 & Both & Global growth; cement decarbonisation cost & IMF; IEA & IMF, July 2026 World Economic Outlook Update; IEA, Breakthrough Agenda Report 2025 --- Cement and Concrete. & 30-Aug-26\\
\end{tabular}\par}

\vspace{2mm}
\begin{okbox}\boxtitleg{On the company-profile data in Sections 2 and 15}
Board composition, senior management, the shareholding pattern by category, the
product portfolio and the margin, working-capital and depreciation analysis all trace
to the companies' own FY2025-26 reports and filings, with page and note references
above. The photographs are the companies' own published images from those same pages.
One item remains open: the reported UltraTech managing-director transition effective
1 April 2026, which falls the day after the valuation date and does not affect any
number in this report.
\end{okbox}

\vspace{3mm}
{\footnotesize\bfseries\color{navy}Authoritative landing pages}\par\vspace{1.5mm}
{\scriptsize\raggedright
\begin{tabular}{@{}p{0.30\textwidth}p{0.66\textwidth}@{}}
Ambuja financials & \texttt{ambujacement.com/investors/financials}\\
UltraTech financials & \texttt{ultratechcement.com/investors/investor-reports}\\
Exchange filings & \texttt{nseindia.com/companies-listing/corporate-filings-financial-results}\\
G-Sec par yields (FBIL series) & \texttt{rbi.org.in/Scripts/BS\_ViewBulletin.aspx}\\
ERP and default spreads & \texttt{pages.stern.nyu.edu/\textasciitilde adamodar/New\_Home\_Page/datacurrent.html}\\
Sector betas & \texttt{pages.stern.nyu.edu/\textasciitilde adamodar/New\_Home\_Page/datafile/Betas.html}\\
\end{tabular}\par
\vspace{1.5mm}
Deep links to individual PDFs are deliberately not given: they are unstable, and citing
a precise document URL that was not actually followed would be worse than citing the
page that was. Each report is identified by name, year and note reference in the table
above, which is sufficient to locate the exact figure.\par}
...
\subsubsection{Three open sourcing items remain} Ambuja's merger swap ratios and
UltraTech's capacity, utilisation and capex guidance reached the models through broker
research, which our policy does not admit; UltraTech's standalone capacity of 172.5
Mn.T is a derivation rather than a disclosure; and the reported UltraTech
managing-director transition of 1 April 2026 is unconfirmed against a primary filing.
The company-profile data added in Sections 2 and 15 — board, management, shareholding,
products, margin stack, working capital and depreciation — is fully sourced to the
FY2025-26 reports and filings.
...
\subsubsection{The depreciation base is now quantified, and it runs against us}
Note 49 discloses Rs 607 crore of intangible amortisation in FY2025-26 against a
forecast that holds the intangible balance flat. Modelling it explicitly would reduce
NOPAT and lower the valuation. The asset-consistency verdict stays PARTIAL, but the
...
\clearpage
\section*{L\quad Governance, disclosure quality and ESG}

\begin{paracol}{2}
\subsection*{L.1\quad The two boards compared}

Both boards are, on paper, well constituted. Ambuja runs eight directors of whom five
are independent (62.5\%), with reported average attendance of 96.24\% and eleven
committees — five statutory and six additional, covering mergers and acquisitions,
technology and data security, commodity prices, legal and tax, and corporate
responsibility and reputation risk. UltraTech runs ten directors of whom five are
independent (50\%), with six principal committees.

Breadth of committee coverage is not what separates them. What separates them is the
question each board has to answer.

\subsection*{L.2\quad The governance question is different at each}

At \textbf{Ambuja} the question is whether acquisition goodwill can ever earn its cost.
Four acquisitions in three years put Rs 22,979 crore of goodwill and intangibles on the
balance sheet — 34.2\% of invested capital — against a return on capital that has never
reached its cost in either year of available consolidated history. The governance
bridge that matters runs from transaction approval to post-acquisition accountability:
capex, integration cost, minority dilution and ROIC tracked together rather than
separately.

At \textbf{UltraTech} the company does earn above its cost of capital, so the question
is narrower: whether the board holds management to a return on the enlarged asset base
rather than to absolute EBITDA growth. Reported ROIC fell from 14.5\% in FY2021-22 to
10.8\% in FY2025-26 while EBITDA rose — exactly the pattern a scale-focused scorecard
would miss.

\subsection*{L.3\quad Quality of disclosure}

Both companies disclose well by Indian large-cap standards, and this report would not
have been possible otherwise. Three observations nonetheless follow from building the
models.

\subsubsection{Ambuja's consolidated history is too short} The annual report provides
FY2025-26 and a restated FY2024-25 and no more, on a consolidated basis. A company that
has just completed four acquisitions is precisely the company whose multi-year
consolidated trend a reader most needs.

\subsubsection{The reported tax line misleads on its face} A reported effective rate of
minus 71\% is fully explained in the notes, so this is a presentation point rather than
a disclosure failure. But a reader relying on headline profit would be seriously
misled, and the company could usefully present a normalised figure alongside.

\subsubsection{Volume and capacity splits are incomplete} Ambuja discloses volume and
capacity consolidated only, which prevents a two-block standalone-and-subsidiary
forecast. UltraTech's standalone capacity had to be derived rather than read.

\switchcolumn
\begin{extab}{Board composition, side by side}{Sources: Ambuja FY2025-26 Integrated
Annual Report, pp. 230--231; UltraTech Board of Directors disclosures.}
\begin{tabular}{@{}p{0.50\linewidth}rr@{}}
\hrow \wh{} & \wh{Ambuja} & \wh{UltraTech}\\
Directors & 8 & 10\\
\arow Independent directors & 5 & 5\\
\trow \textbf{Independence} & \textbf{62.5\%} & \textbf{50\%}\\
Executive directors & 1 & 2\\
\arow Statutory committees & 5 & 6\\
Additional committees & 6 & —\\
\arow Reported attendance & 96.24\% & n/d\\
Promoter holding & 67.33\% & 59.33\% \\
\arow Promoter shares pledged & none & none\\
Foreign institutional holding & 5.63\% & n/d\\
\arow Domestic institutional holding & 17.54\% & n/d\\
\end{tabular}
\end{extab}

\begin{warnbox}\boxtitler{How to read an impairment, if one comes}
A goodwill write-down at Ambuja would be non-cash and would not change our valuation by
a rupee, because we discount cash flows rather than book values. It would however be an
admission that the acquired businesses are worth less than was paid, and it would
mechanically \emph{improve} reported return on capital by shrinking the denominator.
Read it as confirmation of the thesis, not as a new event — and do not read the
subsequent ROIC improvement as operational progress.
\end{warnbox}

\subsection*{L.4\quad Why ESG does not enter the valuation}

We do not adjust the discount rate or the cash flows for ESG factors, and this is a
deliberate methodological position. Both companies' green power, waste heat recovery
and alternative fuel programmes already appear in the forecasts as the cost improvement
that lifts EBITDA per tonne. UltraTech's green power share of 43\% rising toward 65\%
and its guided Rs 300 per tonne cost saving are inside our EBITDA-per-tonne path.
Adding an ESG premium or discount on top would count the same effect twice — a breach
of the assumptions consistency this report is built on.

We also do not use third-party ESG scores. They vary widely between providers for the
same company, their methodologies are not disclosed in enough detail to audit, and they
are not an authorised source under the data policy applied throughout this work.

\begin{okbox}\boxtitleg{Where decarbonisation would change the answer}
If carbon pricing or a binding clinker-factor regulation arrived, it would enter the
model as a cost per tonne and would be visible immediately in the EBITDA-per-tonne
driver. The IEA's estimate that early near-zero cement plants cost 75--150\% more than
conventional production is the right order of magnitude for what such a transition
would do to the capital base — and it would fall hardest on the producer with the
weakest returns, which is Ambuja.
\end{okbox}
\end{paracol}
